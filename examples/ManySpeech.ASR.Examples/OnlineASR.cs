...
{
    internal partial class OnlineASR : BaseASR
    {
        ...
        public static void Recognize(string streamDecodeMethod = "one", string modelName = "paraformer-large-zh-en-int8-onnx-online", string modelAccuracy = "int8", int threadsNum = 2, string[]? mediaFilePaths = null, string? modelBasePath = null)
        {
            ...
            if (streamDecodeMethod == "one")
            {
                ...
                {
                    ASR.OnlineStream stream = onlineRecognizer.CreateOnlineStream();
            ...
            //{
            //    //batch stream decode
            //    List<ASR.OnlineStream> onlineStreams = new List<ASR.OnlineStream>();
            ...
            //    }
            //    int i = 0;
            //    List<ASR.OnlineStream> streams = new List<ASR.OnlineStream>();

            //    while (true)
            //    {
            //        streams = new List<ASR.OnlineStream>();
            ...
            //            }
            //        }
            //        List<ASR.Model.OnlineRecognizerResultEntity> results_batch = onlineRecognizer.GetResults(streams);
            //        foreach (ASR.Model.OnlineRecognizerResultEntity result in results_batch)
            //        {
