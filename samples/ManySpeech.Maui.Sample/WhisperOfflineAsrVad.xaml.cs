...
public partial class WhisperOfflineAsrVad : ContentPage
{
    ...
    #region callback
    private void SetOfflineRecognizerCallbackForResult(OfflineWhisperAsrRecognizer recognizer, string? recognizerType, string outputFormat = "txt", int startIndex = 0, List<List<int[]>> timestampsList = null)
    {
