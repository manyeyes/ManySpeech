...
public partial class WenetOfflineAsrVad : ContentPage
{
    ...
    #region callback
    private void SetOfflineRecognizerCallbackForResult(OfflineWenetAsrRecognizer recognizer, string? recognizerType, string outputFormat = "txt", int startIndex = 0, List<List<int[]>> timestampsList = null)
    {
