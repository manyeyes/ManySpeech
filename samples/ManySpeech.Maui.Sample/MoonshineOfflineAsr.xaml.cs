...
public partial class MoonshineOfflineAsr : ContentPage
{
    ...
    #region callback
    private void SetOfflineRecognizerCallbackForResult(OfflineMoonshineAsrRecognizer recognizer, string? recognizerType, string outputFormat = "text")
    {
        int i = 0;
