...
public partial class K2TransducerOfflineAsrVad : ContentPage
{
    ...
    // 2.搜索 K2transducer 离线模型（非流式模型）
    // 3.设置 _modelName = [模型名称]
    private string _modelName = "k2transducer-zipformer-ctc-small-zh-onnx-offline-20250716";
    ...
    public K2TransducerOfflineAsrVad()
    {
        InitializeComponent();
        CheckModels();
    ...
    #region callback
    private void SetOfflineRecognizerCallbackForResult(OfflineK2TransducerAsrRecognizer recognizer, string? recognizerType, string outputFormat = "txt", int startIndex = 0, List<List<int[]>> timestampsList = null)
    {
    ...
    private void SetOfflineRecognizerCallbackForCompleted(OfflineK2TransducerAsrRecognizer recognizer)
    {
