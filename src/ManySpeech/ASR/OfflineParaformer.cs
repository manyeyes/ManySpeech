...
{
    internal class OfflineProjOfParaformer : IOffline, IDisposable
    {
        ...
        private ModelOutputEntity ModelProj(List<OfflineInputEntity> modelInputs)
        {
            ...
            try
            {
                ...
                if (results != null)
                {
                    ...
                    if (resultsArray.Length >= 4)
                    {
                        ...
                        modelOutputEntity.CifPeak = cif_peak_tensor;
                    }
                }
            }
            catch (Exception ex)
