...
namespace ManySpeech.AliParaformerAsr.Model
{
    ...
    public class ConfEntity
    {
        ...
        private PreEncoderConfEntity _preencoder_conf = new PreEncoderConfEntity();
        ...
        public PreEncoderConfEntity preencoder_conf { get => _preencoder_conf; set => _preencoder_conf = value; }
