...
namespace ManySpeech.AliParaformerAsr
{
    ...
    internal class OnlineWavFrontend
    {
        ...
        //public OnlineWavFrontend(string mvnFilePath, FrontendConf frontendConf)
        public OnlineWavFrontend(FrontendConf? frontendConf = null, string? mvnFilePath = null)
        {
        ...
        public float[] GetFeatures(float[] samples)
        {
            ...
            {
                features = _onlineFbank.GetFbank(features);//GetFbankIndoor
            }
            return features;
        }
