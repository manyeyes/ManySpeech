...
{
    internal class OnlineProj : IOnlineProj, IDisposable
    {
        ...
        public OnlineProj(OnlineModel onlineModel)
        {
            ...
            //_confEntity = onlineModel.ConfEntity;
        }
        ...
        public EncoderOutputEntity EncoderProj(List<OnlineInputEntity> modelInputs)
        {
