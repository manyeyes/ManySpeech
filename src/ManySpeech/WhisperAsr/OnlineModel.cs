...
{
    public class OnlineModel : IDisposable
    {
        ...
        public OnlineModel(string encoderFilePath, string decoderFilePath, ConfEntity confEntity, string configFilePath = "", int threadsNum = 2)
        {
